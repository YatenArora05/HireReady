        ...
        <div style={panelWrapStyle}>
          ...
          >
            ...
            <form style={formBaseStyle} onSubmit={handleSubmit}>
              <motion.button whileHover={{ y: -1 }} whileTap={{ scale: 0.99 }} style={{ ...googleBtnStyle, opacity: 0.6, cursor: "not-allowed" }} type="button" disabled>
              ...
              {isSignUp ? (
                <div style={formRowStyle}>
                  <div style={fieldStyle}>
                    ...
                    <input style={inputStyle} type="text" placeholder="Alex" value={firstName} onChange={(e) => setFirstName(e.target.value)} />
                  </div>
                  <div style={fieldStyle}>
                    <label style={labelStyle}>Last name</label>
                    <input style={inputStyle} type="text" placeholder="Morgan" value={lastName} onChange={(e) => setLastName(e.target.value)} />
                  </div>
                </div>
              ) : null}
              ...
              <div style={fieldStyle}>
                ...
                <input style={inputStyle} type="email" placeholder="alex@example.com" value={email} onChange={(e) => setEmail(e.target.value)} />
              </div>
              ...
              {error ? (
                <p style={{ color: "#ff8f8f", fontSize: "12px", marginBottom: "10px" }}>{error}</p>
              ) : null}

              <motion.button whileHover={{ opacity: 0.88 }} whileTap={{ scale: 0.99 }} style={primaryBtnStyle} type="submit" disabled={isSubmitting}>
